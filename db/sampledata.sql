...
INSERT INTO "tbl_user" ("fld_user_id", "fld_role_id", "fld_user_email", "fld_user_pwhash", "fld_user_creationpit", "fld_user_verified", "fld_user_firstname", "fld_user_lastname", "fld_user_nickname", "fld_user_picture", "fld_user_description", "fld_user_locked", "fld_user_deletionpit", "fld_user_isadmin") VALUES
(1,	2,	'eucbrwef@wkoiu.com',	'$2y$10$M355suZPfy3hKc8HGfDzyejYBveNTZ7GgC.SFmyglO5Y0EPYhkZb6',	'2019-11-24 15:20:11',	't',	'Roman',	'Bögli',	'romusch',	NULL,	NULL,	'f',	NULL,	NULL),
(2,	2,	'wdcoqxmx@zjubm.com',	'$2y$10$ocee0rWa6Tm/E32KIf2yquAQ3SxK.M4K9XS3CUJFO.oV7rjsnaFSy',	'2019-11-24 15:38:43',	't',	NULL,	NULL,	'toby',	NULL,	NULL,	'f',	NULL,	NULL);


INSERT INTO "tbl_category" ("fld_cate_id", "fld_cate_name") VALUES
(1,	'Lifestyle'),
(2,	'Food'),
(3,	'Travel'),
(4,	'Technology'),
...
INSERT INTO "tbl_content" ("fld_cont_id", "fld_user_id", "fld_cate_id", "fld_accc_id", "fld_scon_id", "fld_cont_title", "fld_cont_subtitle", "fld_cont_body", "fld_cont_creationpit", "fld_cont_satoshis", "fld_cont_etr") VALUES
(2,	1,	NULL,	1,	2,	'Sample Title',	'Sample Subtitle',	'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas porttitor congue massa. Fusce posuere, magna sed pulvinar ultricies, purus lectus malesuada libero, sit amet *commodo magna eros quis urna.*
...
(1,	1,	NULL,	2,	2,	'This is me',	'A brief summary',	'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas porttitor congue massa. Fusce posuere, magna sed pulvinar ultricies, purus lectus malesuada libero, sit amet commodo magna eros quis urna.
Nunc viverra imperdiet enim. Fusce est. Vivamus a tellus.
Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Proin pharetra nonummy pede. Mauris et orci.
Aenean nec lorem. In porttitor. Donec laoreet nonummy augue.
Suspendisse dui purus, scelerisque at, vulputate vitae, pretium mattis, nunc. Mauris eget neque at sem venenatis eleifend. Ut nonummy.
...
(3,	1,	NULL,	1,	2,	'Summer in California',	'How the cool people spend their summer holiday',	'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?
...
(4,	1,	NULL,	2,	2,	'Translation World',	'Some thought by H. Rackham',	'### **Intro**
...
(6,	2,	NULL,	1,	2,	'Random Text Generator',	'',	'Great [tool](https://www.randomtextgenerator.com/) to generate some sample articles
',	'2019-11-24 15:43:13',	0,	NULL),
(7,	2,	NULL,	2,	2,	'Limits Expect Wonder',	'Now has you views woman noisy match money rooms?',	'An so vulgar to on points wanted. Not rapturous resolving continued household northward gay. He it otherwise supported instantly. Unfeeling agreeable suffering it on smallness newspaper be. So come must time no as. Do on unpleasing possession as of unreserved. Yet joy exquisite put sometimes enjoyment perpetual now. Behind lovers eat having length horses vanity say had its.
...
(5,	2,	NULL,	2,	2,	'Lorem Ipsum',	'When, and when not to use it',	'Do you like Cheese Whiz? Spray tan? Fake eyelashes? That''s what is Lorem Ipsum to many—it rubs them the wrong way, all the way. It''s unreal, uncanny, makes you wonder if something is wrong, it seems to seek your attention for all the wrong reasons. Usually, we prefer the real thing, wine without sulfur based preservatives, real butter, not margarine, and so we''d like our layouts and designs to be filled with real words, with thoughts that count, information that has value.
