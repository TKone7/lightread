...
class PaymentDAO extends BasicDAO
{
    ...
    /**
     * Finds a payment by its payment request
     * @param $pay_req
     * @return Payment|null
     */
    ...
    /**
     * Checks if the user paid for the content already.
     *
     * @param User $user
    ...
    /**
     * Checks if the anonymous user paid for the content already.
     *
    ...
    /**
     * Select all the turnover generated by a content.
     * @param Content $content
     * @param Purpose|NULL $purpose Optional, all chosen when left NULL
     * @return double
     */
    ...
    /**
     * Select all the turnover generated by the users content.
     *
     * @param User $user
    ...
    /**
     * All settled payments received by a given User
     * @param User $user
     * @return Payment[]
     */
    ...
    /**
     * All settled payments made by a given User
     * @param User $user
     * @return Payment[]
     */
    ...
    /**
     * Change the paying party from an authtoken to a user.
     *
     * @param AuthToken $fromToken
     * @param User $toUser
