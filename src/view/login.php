        ...
        <div class="row">
            <div class="col-md-10 col-lg-8 mx-auto">
                <form method="post" action="<?php echo $GLOBALS["ROOT_URL"]; ?>/login">
                    <div class="form-label-group"><input name="email" class="form-control" type="text" id="inputEmail" placeholder="Email address" required="" autofocus=""><label for="inputEmail">Email address</label></div>
