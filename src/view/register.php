        ...
        <div class="row">
            <div class="col-md-10 col-lg-8 mx-auto">
                ...
                <form method="post" action="<?php echo $GLOBALS["ROOT_URL"]; ?>/register">
                    ...
                    <div class="form-label-group"><input name="email" class="form-control" type="email" id="inputEmailReg" for="inputEmailReg" placeholder="Email address" required=""><label for="inputEmailReg">Email address</label></div>
